...
module.exports = {
    ...
    devServer : {
        port: 6969,
        contentBase: helpers.root('.', '/src/client'),
	   ...
	   proxy: {
		...
		'/placeOrder': 'http://localhost:1234'
	   }
    },
    entry: helpers.root('.', '/src/client/index.tsx'),
    output: {
    ...
    resolve: {
        extensions : ['.ts', '.tsx', '.css','.js', '.svg', '.jpg', '.png', '.ttf', '.otf', '.eot', '.woff']
    },
    plugins : [
